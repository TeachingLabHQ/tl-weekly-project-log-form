...
var DataRouterStateHook = function(DataRouterStateHook4) {
  DataRouterStateHook4["UseBlocker"] = "useBlocker";
  DataRouterStateHook4["UseLoaderData"] = "useLoaderData";
  DataRouterStateHook4["UseActionData"] = "useActionData";
  DataRouterStateHook4["UseRouteError"] = "useRouteError";
  DataRouterStateHook4["UseNavigation"] = "useNavigation";
  DataRouterStateHook4["UseRouteLoaderData"] = "useRouteLoaderData";
  DataRouterStateHook4["UseMatches"] = "useMatches";
  DataRouterStateHook4["UseRevalidator"] = "useRevalidator";
  DataRouterStateHook4["UseNavigateStable"] = "useNavigate";
  DataRouterStateHook4["UseRouteId"] = "useRouteId";
  return DataRouterStateHook4;
}(DataRouterStateHook || {});
...
var AwaitRenderStatus = function(AwaitRenderStatus3) {
  AwaitRenderStatus3[AwaitRenderStatus3["pending"] = 0] = "pending";
  AwaitRenderStatus3[AwaitRenderStatus3["success"] = 1] = "success";
  AwaitRenderStatus3[AwaitRenderStatus3["error"] = 2] = "error";
  return AwaitRenderStatus3;
}(AwaitRenderStatus || {});
...
(function(DataRouterStateHook4) {
  DataRouterStateHook4["UseFetcher"] = "useFetcher";
  DataRouterStateHook4["UseFetchers"] = "useFetchers";
  DataRouterStateHook4["UseScrollRestoration"] = "useScrollRestoration";
...
var DataRouterContext2 = React3.createContext(null);
if (true) {
  DataRouterContext2.displayName = "DataRouter";
}
var DataRouterStateContext2 = React3.createContext(null);
if (true) {
  DataRouterStateContext2.displayName = "DataRouterState";
}
var AwaitContext2 = React3.createContext(null);
if (true) {
  AwaitContext2.displayName = "Await";
}
var NavigationContext2 = React3.createContext(null);
if (true) {
  NavigationContext2.displayName = "Navigation";
}
var LocationContext2 = React3.createContext(null);
if (true) {
  LocationContext2.displayName = "Location";
}
var RouteContext2 = React3.createContext({
  outlet: null,
  matches: [],
  isDataRoute: false
});
...
var RouteErrorContext2 = React3.createContext(null);
if (true) {
  RouteErrorContext2.displayName = "RouteError";
}
var OutletContext2 = React3.createContext(null);
...
var defaultErrorElement2 = React3.createElement(DefaultErrorComponent2, null);
...
var DataRouterStateHook3 = function(DataRouterStateHook4) {
  DataRouterStateHook4["UseBlocker"] = "useBlocker";
  DataRouterStateHook4["UseLoaderData"] = "useLoaderData";
  DataRouterStateHook4["UseActionData"] = "useActionData";
  DataRouterStateHook4["UseRouteError"] = "useRouteError";
...
function useDataRouterState3(hookName) {
  let state = React3.useContext(DataRouterStateContext2);
  !state ? true ? invariant(false, getDataRouterConsoleError3(hookName)) : invariant(false) : void 0;
  return state;
}
function useRouteContext2(hookName) {
  let route = React3.useContext(RouteContext2);
  !route ? true ? invariant(false, getDataRouterConsoleError3(hookName)) : invariant(false) : void 0;
  return route;
}
...
function useRouteError2() {
  var _state$errors;
  let error = React3.useContext(RouteErrorContext2);
  let state = useDataRouterState3(DataRouterStateHook3.UseRouteError);
  let routeId = useCurrentRouteId2(DataRouterStateHook3.UseRouteError);
  if (error !== void 0) {
    return error;
  }
  return (_state$errors = state.errors) == null ? void 0 : _state$errors[routeId];
...
var AwaitRenderStatus2 = function(AwaitRenderStatus3) {
  AwaitRenderStatus3[AwaitRenderStatus3["pending"] = 0] = "pending";
  AwaitRenderStatus3[AwaitRenderStatus3["success"] = 1] = "success";
  AwaitRenderStatus3[AwaitRenderStatus3["error"] = 2] = "error";
  return AwaitRenderStatus3;
...
var RemixContext = React9.createContext(void 0);
...
var NavLink2 = React9.forwardRef(({
  to,
  prefetch = "none",
  discover = "render",
  ...props
  ...
  return React9.createElement(React9.Fragment, null, React9.createElement(NavLink, _extends4({}, props, prefetchHandlers, {
    ref: mergeRefs(forwardedRef, ref),
    to,
    "data-discover": getDiscoverAttr(discover, isAbsolute, props.reloadDocument)
  })), shouldPrefetch && !isAbsolute ? React9.createElement(PrefetchPageLinks, {
    page: href
  }) : null);
});
NavLink2.displayName = "NavLink";
var Link2 = React9.forwardRef(({
  to,
  prefetch = "none",
  discover = "render",
  ...props
  ...
  let href = useHref(to);
  let [shouldPrefetch, ref, prefetchHandlers] = usePrefetchBehavior(prefetch, props);
  return React9.createElement(React9.Fragment, null, React9.createElement(Link, _extends4({}, props, prefetchHandlers, {
    ref: mergeRefs(forwardedRef, ref),
    to,
    "data-discover": getDiscoverAttr(discover, isAbsolute, props.reloadDocument)
  })), shouldPrefetch && !isAbsolute ? React9.createElement(PrefetchPageLinks, {
...
function Links() {
  ...
  return React9.createElement(React9.Fragment, null, criticalCss ? React9.createElement("style", {
    dangerouslySetInnerHTML: {
      __html: criticalCss
    }
  }) : null, keyedLinks.map(({
    key,
    link
  }) => isPageLinkDescriptor(link) ? React9.createElement(PrefetchPageLinks, _extends4({
    key
  }, link)) : React9.createElement("link", _extends4({
    key
  }, link))));
}
function PrefetchPageLinks({
  ...
  return React9.createElement(PrefetchPageLinksImpl, _extends4({
    page,
    matches
  }, dataLinkProps));
}
...
function PrefetchPageLinksImpl({
  ...
  return React9.createElement(React9.Fragment, null, dataHrefs.map((href) => React9.createElement("link", _extends4({
    key: href,
    rel: "prefetch",
    as: "fetch",
    href
  }, linkProps))), moduleHrefs.map((href) => React9.createElement("link", _extends4({
    key: href,
    rel: "modulepreload",
    href
    ...
    React9.createElement("link", _extends4({
      key
    }, link))
  )));
}
function Meta() {
  ...
  return React9.createElement(React9.Fragment, null, meta.flat().map((metaProps) => {
    ...
    if ("tagName" in metaProps) {
      ...
      let Comp = tagName;
      return React9.createElement(Comp, _extends4({
        key: JSON.stringify(rest)
      }, rest));
    }
    if ("title" in metaProps) {
      return React9.createElement("title", {
        key: "title"
    ...
    if ("charSet" in metaProps && metaProps.charSet != null) {
      return typeof metaProps.charSet === "string" ? React9.createElement("meta", {
        key: "charSet",
    ...
    return React9.createElement("meta", _extends4({
...
function Await2(props) {
  return React9.createElement(Await, props);
}
    ...
    contextScript += !activeDeferreds ? "" : ["__remixContext.p = function(v,e,p,x) {", "  if (typeof e !== 'undefined') {", true ? "    x=new Error(e.message);\n    x.stack=e.stack;" : '    x=new Error("Unexpected Server Error");\n    x.stack=undefined;', "    p=Promise.reject(x);", "  } else {", "    p=Promise.resolve(v);", "  }", "  return p;", "};", "__remixContext.n = function(i,k) {", "  __remixContext.t = __remixContext.t || {};", "  __remixContext.t[i] = __remixContext.t[i] || {};", "  let p = new Promise((r, e) => {__remixContext.t[i][k] = {r:(v)=>{r(v);},e:(v)=>{e(v);}};});", typeof abortDelay === "number" ? `setTimeout(() => {if(typeof p._error !== "undefined" || typeof p._data !== "undefined"){return;} __remixContext.t[i][k].e(new Error("Server timeout."))}, ${abortDelay});` : "", "  return p;", "};", "__remixContext.r = function(i,k,v,e,p,x) {", "  p = __remixContext.t[i][k];", "  if (typeof e !== 'undefined') {", true ? "    x=new Error(e.message);\n    x.stack=e.stack;" : '    x=new Error("Unexpected Server Error");\n    x.stack=undefined;', "    p.e(x);", "  } else {", "    p.r(v);", "  }", "};"].join("\n") + Object.entries(activeDeferreds).map(([routeId, deferredData]) => {
      ...
      let promiseKeyValues = deferredData.deferredKeys.map((key) => {
        if (pendingKeys.has(key)) {
          deferredScripts.push(React9.createElement(DeferredHydrationScript, {
            key: `${routeId} | ${key}`,
            deferredData,
            routeId,
            dataKey: key,
...
import(${JSON.stringify(manifest.entry.module)});`;
    return React9.createElement(React9.Fragment, null, React9.createElement("script", _extends4({}, props, {
      suppressHydrationWarning: true,
      dangerouslySetInnerHTML: createHtml(contextScript),
      type: void 0
    })), React9.createElement("script", _extends4({}, props, {
      suppressHydrationWarning: true,
...
function DeferredHydrationScript({
  ...
  return React9.createElement(React9.Suspense, {
    fallback: (
      // This makes absolutely no sense. The server renders null as a fallback,
      // but when hydrating, we need to render a script tag to avoid a hydration issue.
      // To reproduce a hydration mismatch, just render null as a fallback.
      typeof document === "undefined" && deferredData && dataKey && routeId ? null : React9.createElement("script", _extends4({}, scriptProps, {
        async: true,
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
          __html: " "
  ...
  }, typeof document === "undefined" && deferredData && dataKey && routeId ? React9.createElement(Await2, {
    resolve: deferredData.data[dataKey],
    errorElement: React9.createElement(ErrorDeferredHydrationScript, {
      dataKey,
      routeId,
      scriptProps,
      serializeError: serializeError2
    ...
    children: (data3) => {
      return React9.createElement("script", _extends4({}, scriptProps, {
        async: true,
        suppressHydrationWarning: true,
        dangerouslySetInnerHTML: {
  ...
  }) : React9.createElement("script", _extends4({}, scriptProps, {
    async: true,
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
      __html: " "
...
function RemixBrowser(_props) {
  ...
  return (
    ...
    React10.createElement(React10.Fragment, null, React10.createElement(RemixContext.Provider, {
      value: {
      ...
      location
    }, React10.createElement(RouterProvider, {
      router,
      fallbackElement: null,
      future: {
        v7_startTransition: true
      }
    }))), window.__remixContext.future.v3_singleFetch ? React10.createElement(React10.Fragment, null) : null)
  );
}
...
function ScrollRestoration2({
  ...
  return React11.createElement("script", _extends4({}, props, {
    suppressHydrationWarning: true,
    dangerouslySetInnerHTML: {
...
function StaticRouterProvider({
  ...
  return React12.createElement(React12.Fragment, null, React12.createElement(DataRouterContext.Provider, {
    value: dataRouterContext
  }, React12.createElement(DataRouterStateContext.Provider, {
    value: state
  }, React12.createElement(FetchersContext.Provider, {
    value: fetchersContext
  }, React12.createElement(ViewTransitionContext.Provider, {
    value: {
      isTransitioning: false
    }
  }, React12.createElement(Router, {
  ...
  }, React12.createElement(DataRoutes2, {
    routes: router2.routes,
    future: router2.future,
    state
  })))))), hydrateScript ? React12.createElement("script", {
    suppressHydrationWarning: true,
    nonce,
    dangerouslySetInnerHTML: {
...
function RemixServer({
  ...
  return React13.createElement(React13.Fragment, null, React13.createElement(RemixContext.Provider, {
    value: {
      manifest,
      routeModules,
      criticalCss,
  ...
  }, React13.createElement(RemixErrorBoundary, {
    location: router2.state.location
  }, React13.createElement(StaticRouterProvider, {
    router: router2,
    context: context.staticHandlerContext,
    hydrate: false
  }))), context.future.v3_singleFetch && context.serverHandoffStream ? React13.createElement(React13.Suspense, null, React13.createElement(StreamTransfer, {
    context,
    identifier: 0,
